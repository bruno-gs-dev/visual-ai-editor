...
var MESSAGES = {
  en: {
    ...
    'edit.no-api-key': 'Server has no AI API key configured. Set AI_API_KEY (or GROQ_API_KEY) in your .env.',
  ...
  'pt-BR': {
    ...
    'edit.no-api-key': 'Servidor sem chave de API de IA configurada. Defina AI_API_KEY (ou GROQ_API_KEY) no .env.',
